...
CREATE TABLE IF NOT EXISTS ux_reports (
  ...
  date TEXT NOT NULL,
  summary TEXT,
  executive_summary TEXT, -- Jurnii: Executive summary section
  perception JSONB, -- Jurnii: Perception section (can be string or array)
  journey JSONB, -- Jurnii: Journey section (can be string or array)
  trends JSONB, -- Jurnii: Trends section (can be string or array)
  performance JSONB, -- Jurnii: Performance section (can be string or array)
  checking JSONB, -- Jurnii: Checking section (can be string or array)
